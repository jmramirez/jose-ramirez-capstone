...
namespace PartyAgile.API.Migrations
{
    ...
    [Migration("20211006205102_RemoveBudgetFromVendor")]
    partial class RemoveBudgetFromVendor
    {
            ...
            modelBuilder.Entity("PartyAgile.Domain.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("068eea1b-ac80-48fb-aad0-44ab26aa4c3e"),
                            ConcurrencyStamp = "0b15fea3-ef47-4378-b84b-9f4debff0674",
                            Name = "Planner"
                        },
                        new
                        {
                            Id = new Guid("6319fe57-263b-40fa-aea0-974e98467161"),
                            ConcurrencyStamp = "753fa037-c204-4283-a236-b328db965c27",
                            Name = "Vendor"
                        });
                });
