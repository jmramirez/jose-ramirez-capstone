...
namespace PartyAgile.API.Migrations
{
    ...
    [Migration("20210920161400_RolesData")]
            ...
            modelBuilder.Entity("PartyAgile.Domain.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c9670787-e5a8-44bd-9642-e30ba3fd3ea4"),
                            ConcurrencyStamp = "bccd859c-b618-4f78-9bb3-e55e070aa645",
                            Name = "Planner"
                        },
                        new
                        {
                            Id = new Guid("df1a1ecd-7d51-4251-97e6-1c90fc7f2d4b"),
                            ConcurrencyStamp = "7b201528-6ccf-4be2-a718-f109a84b482e",
                            Name = "Vendor"
                        });
                });
