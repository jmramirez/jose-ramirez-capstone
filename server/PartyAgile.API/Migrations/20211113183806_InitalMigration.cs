        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatorPhome = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Budget = table.Column<string>(type: "text", nullable: true),
                    DepositPaid = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColorStatus = table.Column<string>(type: "text", nullable: true),
                    VendorId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("5aedca98-6e21-4b5d-85f3-add79eb2f391"), "cd391958-5aaf-4c3b-8057-8339d699d53d", "Planner", "PLANNER" },
                    { new Guid("b9483149-8510-48f9-b421-cb564bed3002"), "3ce1624b-0c49-441c-92ec-9d5af9ee438e", "Vendor", "VENDOR" }
                });
